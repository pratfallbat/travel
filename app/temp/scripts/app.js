...
var StickyHeader = function () {
  ...
  _createClass(StickyHeader, [{
    ...
    value: function createHeaderWaypoints() {
      var that = this;
      new Waypoint({
        element: this.headderTriggerElement[0],
...
var Modal = function () {
  function Modal() {
    ...
    this.modal = new _jquery2.default(".modal");
    ...
    (0, _jquery2.default)(document).on("click", ".modal__close", function () {
  ...
  _createClass(Modal, [{
    ...
    value: function openModel() {
      ...
      (0, _jquery2.default)(document).on("click", ".open-modal", function () {
